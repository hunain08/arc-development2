...
export default function Revolution() {
    ...
    return (
        <Grid container direction="column">
            ...
            >
                <Grid  item lg>
                    <img src={vision} style={{maxWidth:matchesSM ? 400 : "40em",marginRight:matchesmd ? 0 :"5em",marginBottom:matchesmd ? "5em":0}}/>
                </Grid>
                <Grid item container direction="column" lg>
                    ...
                    <Grid item>
                        ...
                        Computer vision, however, is more than machine learning 
                        applied. It involves tasks as 3D scene modeling, 
                        multi-view camera geometry, structure-from-motion,
                         stereo correspondence, 
                        point cloud processing, motion estimation and more
                        </Typography>
                        <Typography align={matchesmd ? "center":"right"} variant="body1" paragraph>
                        Computer vision, however, is more than machine learning 
                        applied. It involves tasks as 3D scene modeling, 
            ...
            <Grid item container className={classes.rowContainer} direction="row" justifyContent="center">
                <Grid item>
                <Typography  variant="h4" gutterBottom>Process</Typography>
                
                </Grid>
            </Grid>
            <Grid item container  direction={matchesmd ? "column":"row"} style={{backgroundColor:"#B3B3B3",height:"90em"}}className={classes.rowContainer}>
                <Grid item container alignItems={matchesmd ? "center" : undefined} direction="column" lg>
                  ...
                  <Grid item>
                      ...
                      A consulting firm provides feedback and actionable strategies to companies
                       to improve their efficiency or effectiveness in a specific area, 
                       such as advertising and technology. Company executives are often 
                       the ones who hire consultants to give 
                      </Typography>
                  </Grid>
                  <Grid item>
                      ...
                      (often referred to as "associate consultants") 
                      can typically expect to earn between $60,000 and $90,000
                      </Typography>
                  </Grid>
                  <Grid item>
                      <Typography variant="body1" style={{color:"#fff",maxWidth:"20em"}} align={matchesmd ? "center":undefined} paragraph>
                      A consulting firm provides feedback and actionable strategies to companies
                       to improve their efficiency or effectiveness in a specific area, 
                       such as advertising and technology. Company executives are often 
                       the ones who hire consultants to give 
                ...
                <Grid item alignItems={matchesmd ? "center" : undefined} lg style={{alignSelf:"center"}}>
                     <img src={consulation} style={{maxWidth:matchesmd?700:1000}}/>   
                </Grid>
            </Grid>
            <Grid  item container  direction={matchesmd ? "column":"row"} style={{backgroundColor:"#FF7373",height:"90em"}}className={classes.rowContainer}>
                <Grid item container direction="column" lg>
                  <Grid item>
                      <Typography  align={matchesmd ? "center":undefined} variant="h4" gutterBottom style={{color:"#000" ,marginTop:"5em"}}>
                      Mock up </Typography>
            ...
            <Grid item container  direction={matchesmd ? "column":"row"} style={{backgroundColor:"#39B54A",height:"90em"}}className={classes.rowContainer}>
                <Grid item container direction="column" lg>
                  <Grid item>
                ...
                <Grid item lg style={{alignSelf:"center"}} alignItems={matchesmd ? "center" : undefined}>
                     <img src={review} style={{maxWidth:matchesmd?700:1000}}/>   
                </Grid>
            </Grid>
            <Grid item container  direction={matchesmd ? "column":"row"} style={{backgroundColor:"#A67C52",height:"90em"}}className={classes.rowContainer}>
                <Grid item container direction="column" lg>
                  <Grid item>
                      <Typography align={matchesmd ? "center":undefined} variant="h4" gutterBottom style={{color:"#000" ,marginTop:"5em"}}>
                     Design </Typography>
            ...
            <Grid item container  direction={matchesmd ? "column":"row"} style={{backgroundColor:"#FBB03B",height:"90em"}}className={classes.rowContainer}>
            ...
            <Grid item container  direction={matchesmd ? "column":"row"} style={{backgroundColor:"#C1272D",height:"90em"}}className={classes.rowContainer}>
                <Grid item container direction="column" lg alignItems={matchesmd ? "center" : undefined}>
                  <Grid item>
                      <Typography variant="h4" gutterBottom  align={matchesmd ? "center":undefined} style={{color:"#000" ,marginTop:"5em"}}>
            ...
            <Grid item container  direction={matchesmd ? "column":"row"} style={{backgroundColor:"#8E45CE",height:"90em"}}className={classes.rowContainer}>
                <Grid item container direction="column" lg>
                  <Grid item>
                      <Typography variant="h4" gutterBottom  align={matchesmd ? "center":undefined} style={{color:"#000" ,marginTop:"5em"}}>
                      Maintain </Typography>
